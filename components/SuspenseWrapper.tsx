...
export function ChartSuspense({ children }: { children: ReactNode }) {
  return <SuspenseWrapper type="chart">{children}</SuspenseWrapper>;
}

export function PageSuspense({ children, message }: { children: ReactNode; message?: string }) {
  return (
...
export function InlineSuspense({ children, message }: { children: ReactNode; message?: string }) {
  return (
